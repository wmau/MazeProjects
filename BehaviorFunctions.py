...
def sync_Arduino_outputs(Arduino_fpath, eztrack_fpath, behav_cam=2):
    ...
    behavior_df = read_eztrack(eztrack_fpath)
    ...
    for i, row in Arduino_data.iterrows():
        ...
        val = row.Data
        if val.isnumeric():
            behavior_df.at[frame_num, 'lick_port'] = val
        elif val == 'Water':
            behavior_df.at[frame_num, 'water'] = True
...
class Preprocess:
    ...
    def find_outliers(self):
        ...
        self.dist_ax.plot(self.behavior_df['distance'], color='r')
